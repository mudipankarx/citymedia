...
$select_pro2="select * from `temp_rec` where `user_id`='".$ses_id."'";
$query_pro2=mysqli_query($mysql_link,$select_pro2);

$select_other2="select * from `other_iteams` where `user_id`='".$ses_id."'";
$query_other2=mysqli_query($mysql_link,$select_other2);
?>
	...
	appointment is confirmed</h2>
				...
				<div class="col-lg-6 col-md-12">
					<div class="thankyou_left">
						...
						$price2=0;
						while($rec_pro2=mysqli_fetch_array($query_pro2)){
							
							$amount2=$rec_pro2['size_price']+$rec_pro2['type_pric']+$rec_pro2['wall_type_price'];
							$price2=$price2+$amount2;?>
						   
							<li><p><b>TV Mounting</b></p></li>
							<li><p><?php echo $rec_pro2['size'];?>&nbsp;&nbsp;&nbsp;-- $<?php echo $price2;?></p></li>
							
						<?php } ?> 
						<li><p><b>Other Items</b></p></li>
						<?php 
						$othe_price2=0;
						while($rec_other2=mysqli_fetch_array($query_other2)){
						$othe_price2=$othe_price2+$rec_other2['oprice'];	
							?>
						   
							<li><p><?php echo $rec_other2['okey'];?>&nbsp;&nbsp;&nbsp;-- $<?php echo $rec_other2['oprice'];?></p></li>
						<?php }?>
						<li><p>Total Price -- <b> $<?php echo $price2+$othe_price2;?></b></p>
							</li>
						  </ul>
