...
$select_query="select * from `wall_type`";
$wall_type_list=mysqli_query($mysql_link,$select_query);
...
if(isset($_POST['wall'])&&$_POST['wall']!='')
{
	$_SESSION["wall_type"] = $_POST['wall'];
	$_SESSION["wall_price"] = $_POST['wall_price'];   
	
	  echo "<script>window.location='need_anything.php'</script>";
}
?>
<section class="comman_tb_padding">
<form name="frm4" id="frm4" method="post" action="">
  <input type="hidden" name="wall" id="wall">
  <input type="hidden" name="wall_price" id="wall_price">
</form>
<div id="root">
  ...
  <div class="container">
	<div class="row">
      ...
      <div class="question-comp-wrapper">
        <?php 
$a=1;
while($list=mysqli_fetch_array($wall_type_list)){
$b=$a;
?>
        <div>
          <div class="single-answer-component-wrapper">
            <div class="fade-on-mount normal-elemnt-active">
              <button class="answer-content" onclick="submit_wall('<?php echo $list['title'];?>','<?php echo $list['price'];?>');">
        ...
        <div> 
          <!--<div class="single-answer-component-wrapper">
<div class="fade-on-mount normal-elemnt-active">
<button class="answer-content" data-toggle="modal" data-target="#myModal"><label>Other</label></button>
</div>
</div>--> 
        </div>
      </div>
        ...
        <div class="mobile-cart-top-content-wrapper ">
          <div class="services-and-prices">
            <div class="prices">
              <div> <span>
                <div class="fade-on-mount normal-elemnt-active">
                  <div> <span><b>$129 </b></span> <span class="small-price-hour"><b>TV Mounting</b></span>
...
<!--<div id="myModal" class="modal fade" role="dialog" >
  <div class="add-to-cart-wrapper" style="text-align: center;
    margin-left: 40%;
    margin-top: 10%;">
    <h2>What type of wall do you have?</h2>
    <div class="new-input-comp">
      <textarea id="type_of_wall" onkeyup="enable_next();"></textarea>
    </div>
    <button class="new-action-button new-action-button-blocklevel" disabled="" onclick="submit_wall(this.value,'0');">Next</button>
    <a href="need_anything.php">
    <button onclick="notsure();" class="new-action-button new-action-button-negative new-action-button-blocklevel">I am not sure</button>
    </a></div>
</div>-->
</section>
<?php
